...
class AppImageData:
        ...
        try:
            ...
            if len(self.raw_images) <= 0:
                ...
                for name in self.raw_images:                                                       
                    PAT = 'CENSORED'                                 # separate key for accessing cloud for downloads
                    headers = {
    ...
    # VERSION 1 (6/19/24) - Segment the images using the CV2/Sobel architecture with Retouch using repetitive dilation/erosion
    # NEXT - fully implement the UNET architecture to improve segmentation accuracy with training on a custom dataset of Final Assembly Images
    def segment(self):
        for image in self.preprocessed_images:
            ...
            self.segmented_images.append(segmented)
    ...
    def github_instruction_publish(self):
        try:
            ...
            for i, image in enumerate(imagedata.final_instruction_images):
                ...
                temp_path = 'C:\\Users\\Bogom\\Documents\\HYDAC S24\\SynthImageDump\\' + imagedata.folder + str(i + 1) + '.png'          # temporary path for storing images
            ...
            pdf_path = 'C:\\Users\\Bogom\\Documents\\HYDAC S24\\SynthImageDump\\' + imagedata.folder + '.pdf'                            # temporary path for storing PDF
